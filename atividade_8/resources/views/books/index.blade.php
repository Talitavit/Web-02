...
<div class="container">
    ...
    <!-- Botões de Adicionar Livro (apenas para admin ou bibliotecário) -->
            ...
            @forelse($books as $book)
                <tr>
                    ...
                    <td>
                        ...
                        <!-- Botão de Editar (apenas para admin ou bibliotecário) -->
                        @if(auth()->user()->role === 'admin' || auth()->user()->role === 'bibliotecario')
                        ...
                        <!-- Botão de Deletar (apenas para admin ou bibliotecário) -->
                        @if(auth()->user()->role === 'admin' || auth()->user()->role === 'bibliotecario')
