...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p>
                @if ($book->cover) 
                    <img src="{{ Storage::url($book->cover) }}" alt="Capa do Livro" style="max-width: 100px; height: auto;">
                @else
                    <img src="storage/public/images/image.png" alt="Imagem Padrão" style="max-width: 100px; height: auto;">
                @endif
            </p>
        </div>
    </div>
