...
class BorrowingController extends Controller
{
    ...
    {
        $borrowings = Borrowing::all();  // Obtenha todos os empréstimos do banco de dados
        return view('borrowings.index', compact('borrowings'));  // Retorne a view com os empréstimos
    }
